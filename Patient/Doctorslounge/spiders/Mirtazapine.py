...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Mirtazapine_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Mirtazapine_url.csv') as fp:
