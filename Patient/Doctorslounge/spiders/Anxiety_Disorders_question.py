...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Anxiety Disorders_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Anxiety Disorders_url.csv') as fp:
