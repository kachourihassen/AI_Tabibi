...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Coronavirus_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Coronavirus_url.csv') as fp:
