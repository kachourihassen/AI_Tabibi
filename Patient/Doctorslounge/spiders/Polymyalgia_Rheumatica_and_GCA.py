...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Polymyalgia_Rheumatica_and_GCA_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Polymyalgia_Rheumatica_and_GCA_url.csv') as fp:
