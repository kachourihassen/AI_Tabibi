...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Menopause_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Menopause_url.csv') as fp:
