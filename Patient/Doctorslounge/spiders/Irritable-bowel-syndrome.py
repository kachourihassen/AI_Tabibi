...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Irritable-bowel-syndrome_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Irritable-bowel-syndrome_url.csv') as fp:
