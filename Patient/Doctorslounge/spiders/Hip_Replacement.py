...
class MedSpider(scrapy.Spider):
    ...
    writer = csv.writer(open("C:/Users/Kachouri/Desktop/Patient/Data/Hip_Replacement_question.csv", 'w'))
    ...
    with open('C:/Users/Kachouri/Desktop/Patient/Hip_Replacement_url.csv') as fp:
